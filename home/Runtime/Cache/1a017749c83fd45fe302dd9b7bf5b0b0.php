			...
			<div id="top">
				<ul>
					...
					<?php if(is_array($result)): foreach($result as $key=>$v): ?><li>
							<dl>
								<dt>
									<a href="__ROOT__/index.php/Index/foodDetail/id/<?php echo ($v["Lid"]); ?>">
										<img width="214px" height="145px" src="__ROOT__<?php echo ($v["Lbig_img"]); ?>" />
									</a>
								</dt>
								<dd class="f1">
									<a href="__ROOT__/index.php/Index/foodDetail/id/<?php echo ($v["Lid"]); ?>"><?php echo ($v["Lname"]); ?></a>
								</dd>
								<dd class="f2">
									<a href="__ROOT__/index.php/Index/foodDetail/id/<?php echo ($v["Lid"]); ?>">&yen;<?php echo ($v["Lnum"]); ?></a>
								</dd>
							</dl>
